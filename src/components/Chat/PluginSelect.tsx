...
export const PluginSelect: FC<Props> = ({
  ...
  return (
    <div className="flex flex-col">
      <div className="mb-1 w-full rounded border border-neutral-200 bg-transparent pr-2 text-neutral-900 dark:border-neutral-600 text-adaptive">
        <select
          ref={selectRef}
        ...
        >
          <option
            key="chatgpt"
            value="chatgpt"
            className="bg-adaptive text-adaptive"
          >
            ChatGPT
          </option>
